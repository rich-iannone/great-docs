...
The `user_guide/` directory should be in your project root. Great Docs copies files to `great-docs/user-guide/` during each build, keeping your source separate from generated output.
