...
Diagrams let you visualize architecture, workflows, and relationships directly in your documentation without external image editors. Mermaid's text-based syntax means diagrams stay in version control and update alongside your prose.

- [Authoring QMD Files](authoring-qmd-files.qmd) covers other content building blocks like callouts, tabsets, and code blocks
