...
Add custom page groups (examples, tutorials, blog, etc.) to your site. Each section gets a navbar link, sidebar, and auto-generated index page:
...
If the directory contains an `index.qmd`, that file is used as the landing page. Otherwise, a gallery-style index is auto-generated from each page's frontmatter.

See [Custom Sections](custom-sections.qmd) for full details.
