...
description: "Catch spelling errors in your documentation before they reach users."
---

Good documentation requires accurate spelling. Great-Docs includes a built-in spell checker that scans your documentation files for spelling errors while intelligently skipping code, URLs, and technical terms.
...
The spell checker will scan all `.qmd` and `.md` files in your docs directory and report any misspellings found.
