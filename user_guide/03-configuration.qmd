...
Both the announcement banner and the navbar support animated gradient backgrounds. Gradients shift slowly across the element, creating a subtle, eye-catching effect. Each preset includes paired light-mode and dark-mode color palettes.
...
| `aurora` | Green → blue → purple sweep |
| `berry` | Purples and magentas |
| `slate` | Subtle cool grays |
| `flame` | Bold reds and oranges |
| `midnight` | Deep blues and indigos |
| `teal` | Fresh teals and cyans |
...
This applies the animated gradient to the site's top navigation bar. All navbar text, links, and icons are automatically adjusted to white for readability.

### Combining Both

You can use the same or different presets for the banner and navbar:
