...
To disable hierarchical tag support and treat `/` as a literal character:
...
You can associate tags with icons from the [Font Awesome](https://fontawesome.com/icons) set. Icons appear inside the tag pill and next to the tag heading on the index page.
...
The icon names correspond to Font Awesome solid icon names (without the `fa-` prefix).
