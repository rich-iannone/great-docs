...
- [Table Explorer](table-explorer.qmd) adds interactive filtering, sorting, and pagination for larger datasets
- [Scale-to-Fit](scale-to-fit.qmd) keeps wide tables readable on narrow screens
- [Writing Docstrings](writing-docstrings.qmd) covers embedding table previews in executable docstring examples
