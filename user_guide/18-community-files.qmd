...
Community files give your project a professional, welcoming presence. Great Docs detects them automatically, so adding a `CONTRIBUTING.md` or `CODE_OF_CONDUCT.md` to your repo is all it takes to get a styled page in your documentation site.
